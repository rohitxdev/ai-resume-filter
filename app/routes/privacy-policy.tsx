const Route = () => {
	return (
		<div className="p-8 [&_h2]:font-semibold [&_h2]:text-xl [&_h3]:font-semibold [&_h3]:text-lg [&_h4]:font-semibold [&_strong]:font-bold">
			<h1 className="text-center font-semibold text-4xl">Privacy Policy</h1>
			...
			<ul>
				...
				<li>
					<p>
						...
						this Agreement) refers to FilterCV.
					</p>
				</li>
				<li>
					<p>
				...
				<li>
					<p>
						<strong>Website</strong> refers to FilterCV, accessible from{" "}
						<a href="https://filtercv.com" rel="noreferrer external nofollow noopener" target="_blank">
							https://filtercv.com
						</a>
					</p>
				</li>
			...
			<ul>
				<li>By email: support@filtercv.com</li>
			</ul>
		</div>
	);
};
